...
export class CustomersComponent
  ...
  filterForm() {
    ...
    this.subscriptions.push(
      this.filterGroup.get('status').valueChanges.subscribe(() =>
        this.filter()
      )
    );
    this.subscriptions.push(
      this.filterGroup.get('type').valueChanges.subscribe(() => this.filter())
    );
  }
  ...
  searchForm() {
    ...
    const searchEvent = this.searchGroup.get('searchTerm').valueChanges
      .pipe(
        /*
